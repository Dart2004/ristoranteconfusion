...
import { Control, Form, Errors, actionTypes } from "react-redux-form";
                    ...
                    <div className="col-12 col-md-9">
                        <Form model="feedback" onSubmit={(values) => this.handleSubmit(values)}>
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text validators={{required, minLength:minLength(3),maxLength:maxLength(15)}} model=".firstname" className="form-control" id="firstname" name="firstname" placeholder="First Name"/>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text validators={{required, minLength:minLength(3),maxLength:maxLength(15)}} model=".lastname" className="form-control" id="lastname" name="lastname" placeholder="Last Name"/>
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text validators={{required, minLength:minLength(3),maxLength:maxLength(15), isNumber}} model=".telnum" className="form-control" id="telnum" name="telnum" placeholder="Tel. Num" />
                            ...
                            <Row className="form-group">
                                ...
                                <Col md={10}>
                                    <Control.text validators={required, validEmail} model=".email" className="form-control" id="email" name="email" placeholder="Email" />
                            ...
                            <Row className="form-group">
                                <Col md={{size: 6, offset:2}}>
                                    <div className="form-check">
                                        <Label check>
                                            <Control.checkbox model=".agree" className="form-check" name="agree" /> {' '}
